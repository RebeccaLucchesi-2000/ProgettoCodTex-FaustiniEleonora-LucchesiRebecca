...
<xsl:stylesheet version="2.0"
    ...
    <xsl:template match="/">
        <html>
            <head>
                <title>Progetto di Codifica di Testi - F. De Saussure</title>
            ...
            <body>
                ...
                <nav class="navMenu">
                    <ul>
                        ...
                        <li>
                            <a href="#p23">Pagina 23</a>
                        </li>
                        <li>
                            <a href="#p24">Pagina 24</a>
                        </li>
                        <li>
                ...
                <div>
                    <div id="info">
                        ...
                        <ul class="legend">
                        <li><span class="mentioned"></span>Esempio linguistico</li>
                        <li><span class="term"></span>Elemento terminologico</li>
                        <li><span class="etc"></span>Antroponimo</li>
                        <li><span class="place"></span>Luogo</li>
                        </ul>
                ...
                <article id="p23">
                    ...
                    <div class="flexbox">
                        <div class="img">
                            <xsl:apply-templates select="//tei:surface[@xml:id='Pag23']" />
                        </div>
                        <div class="text">
                            <xsl:apply-templates select="//tei:body/tei:div[@n = '23']" />
                        </div>
                ...
                <article id="p24">
                    ...
                    <div class="flexbox">
                        <div class="img">
                            <xsl:apply-templates select="//tei:surface[@xml:id='Pag24']" />
                        </div>
                        <div class="testo">
                            <xsl:apply-templates select="//tei:body/tei:div[@n = '24']" />
                        </div>
    ...
    <xsl:template match="tei:editionStmt">
        ...
        <p>Progetto a cura di: <xsl:value-of select="current()/tei:respStmt/tei:name[@xml:id='RL']"></xsl:value-of> e <xsl:value-of select="current()/tei:respStmt/tei:name[@xml:id='EF']"></xsl:value-of>
        </p>
